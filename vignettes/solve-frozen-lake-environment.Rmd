...
We will use the Gym implementation of the FrozenLake environment. Therefore we need to install python and gym-http-api first. Then we can load the `reinforcelearn` package and create the environment.

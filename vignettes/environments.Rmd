...
The original formulation of the problem has three actions: "push left", "no push" and "push right", which are encoded as -1, 0 and 1. The reward for each step is - 1 until the terminal state at the right mountain summit is reached.
